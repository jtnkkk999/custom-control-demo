...
public class MaterialEditText extends android.support.v7.widget.AppCompatEditText {
    ...
    private static final float LABEL_SIZE = Utils.dip2px(12);
    private static final float LABEL_PADDING = Utils.dip2px(8);
    private static final float LABEL_OFFSET = Utils.dip2px(4);
    private static final float LABEL_OFFSET_Y = Utils.dip2px(12);
    private static final float TOTAL_EXTRA_OFFSET = Utils.dip2px(16);
...
//        }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawLine(LABEL_OFFSET + 200,getBottom() - Utils.dip2px(8), getWidth() - LABEL_OFFSET, getBottom() - Utils.dip2px(8), paint);
    }
}
